    ...
    <div className="max-w-[1400px] mx-auto p-6">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-8">
        <h1 className="text-2xl font-light tracking-tight text-gray-900">
          Gestión de <span className="font-medium">Sedes</span>
        </h1>
      ...
      {showFilters && (
        <div className="mb-6 p-4 bg-white rounded-2xl shadow-sm border border-gray-100
          ...
          <select className="px-4 py-2 bg-gray-50 border-0 rounded-lg text-sm text-gray-600
            ...
            <option value="healthservices">HealthServices</option>
          </select>
          <select className="px-4 py-2 bg-gray-50 border-0 rounded-lg text-sm text-gray-600
                         focus:ring-2 focus:ring-blue-500">
          ...
          <table className="w-full border-collapse table-auto">
            <thead>
              <tr className="bg-gray-50/50">
                ...
                <th className="py-3 px-4 text-left text-sm font-medium text-gray-500">
                  {renderSortableHeader('ciudad', 'Ciudad')}
                </th>
                <th className="py-3 px-4 text-left text-sm font-medium text-gray-500">
            ...
            <tbody className="divide-y divide-gray-200">
              {sedesData.map((sede) => (
                <tr key={sede.id} className="hover:bg-gray-50/50">
                  <td className="p-4 text-sm text-gray-600">{sede.nombre}</td>
                  <td className="p-4 text-sm text-gray-600">{sede.empresa}</td>
                  <td className="p-4 text-sm text-gray-600">{sede.direccion}</td>
                  <td className="p-4 text-sm text-gray-600">{sede.ciudad}</td>
                  <td className="p-4 text-sm text-gray-600">{sede.telefono}</td>
                  <td className="p-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            <p className="text-sm text-gray-700 whitespace-nowrap">
              Mostrando <span className="font-medium">2</span> de <span className="font-medium">5</span> sedes
            </p>
